        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    // FIXED: Changed from Vector2[] to var, which resolves to Vector4[] to match the updated TMP API.
                ...
                for (int i = 0; i < textInfo.meshInfo.Length; i++)
                {
                    ...
                    // FIXED: The 'mesh.uv' property expects a Vector2[], but TMP's 'uvs0' is now a Vector4[].
                    // We use SetUVs() instead, which correctly handles the Vector4[] data.
